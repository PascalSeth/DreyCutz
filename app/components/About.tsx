      ...
      <div className="max-w-[1400px] mx-auto px-5 md:px-12 lg:px-16 relative z-10">
            ...
            <div className="relative group mx-auto max-w-[500px] lg:max-w-none">
              ...
              <div className="relative aspect-[4/5] rounded-[2.5rem] overflow-hidden shadow-[0_40px_100px_rgba(0,0,0,0.15)] border-8 border-white transition-all duration-1000 group-hover:rotate-1">
                ...
                <div className="absolute bottom-10 left-10 md:hidden">
                   <p className="text-blue-400 text-[10px] font-black uppercase tracking-[0.4em] mb-2">{t('about.founder_title')}</p>
          ...
          <div className="w-full lg:w-1/2">
            <div className="max-w-xl">
              <div className="hidden md:flex items-center gap-4 mb-8">
                ...
                <span className="text-xs font-bold uppercase tracking-[0.4em] text-blue-600">{t('about.founder_title')}</span>
              </div>

              <h2 className="text-6xl md:text-8xl font-black text-[#1A1A1A] tracking-tighter leading-[0.85] mb-4 uppercase">
                Drey
              </h2>
              <span className="text-3xl md:text-4xl font-light text-gray-400 block mb-12">{t('about.founder_subtitle')}</span>

              <div className="space-y-8">
                <p className="text-xl md:text-2xl font-bold text-[#1A1A1A] leading-tight">
                  {t('about.p1_part1')}<span className="text-blue-600 italic">{t('about.p1_craft')}</span>{t('about.p1_part2')}
                </p>
                ...
                <div className="grid grid-cols-2 gap-6 md:hidden py-8 border-y border-gray-100">
                   <StatItem label={t('about.stat_experience')} value={t('about.stat_experience_val')} />
                   <StatItem label={t('about.stat_specialty')} value={t('about.stat_specialty_val')} />
                </div>
                ...
                <div className="pt-8 md:pt-4">
                  ...
                  >
                    <span className="text-xs font-black uppercase tracking-widest text-white">{t('about.cta')}</span>
        ...
        <div className="hidden md:flex mt-32 pt-16 border-t border-gray-100 items-center justify-between">
           <div className="flex gap-24">
              <StatItem label={t('about.stat_experience')} value={t('about.stat_experience_val')} />
              <StatItem label={t('about.stat_specialty')} value={t('about.stat_specialty_val')} />
              <StatItem label={t('about.stat_location')} value={t('about.stat_location_val')} />
           </div>
